...
public class Old extends javax.swing.JFrame {
    ...
    public Old() {
        ...
        try {
            ...
            String las=rs.getString("close_date");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "pri", "Name", "Surname", "Address", "Amount", "Interest", "Senstion Date", "Close Date ", "Rate", "Mobile No.", "Document"
            }
        ));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       String n=jTextField1.getText();
        ...
        try {
            ...
            String query="Select * from old where name like '%"+n+"%';";
            ResultSet rs=s.executeQuery(query);
            while(rs.next()){
            String pri=rs.getString("pri");
            String name=rs.getString("name");
